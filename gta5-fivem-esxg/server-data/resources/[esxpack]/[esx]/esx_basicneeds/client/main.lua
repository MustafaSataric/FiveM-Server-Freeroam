...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 1000000, '#EC6A13',
		function(status)
			return true
		end,
		function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'thirst', 1000000, '#1B7ED1',
		function(status)
			return true
		end,
		function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'force', 1000000, '     #ffe866', ----- jaune 
         function(status)
            return true
        end,
        function(status)
...
function Drunk(level, start)
 ...
 AddEventHandler('esx_status:loaded', function(status)
   TriggerEvent('esx_status:registerStatus', 'drunk', 0, '#8F15A5', --violet
    function(status)
      if status.val > 0 then
        return true
      else
